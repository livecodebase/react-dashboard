    ...
    var FooPicker = (function() {
      ...
      function FooPicker() {
        ...
        _self.removeListeners = function(id) {
          ...
          htmlRoot.removeEventListener(
            "click",
            _self.handleDocumentClick,
            false
          );
        };
        ...
        _self.handleDocumentClick = function(event) {
          ...
          var pickerDiv = document.getElementById(
      ...
      var Calendar = {
        ...
        buildCalendar: function() {
          ...
          for (; day < daysInMonth; day++) {
            if (day < 0) {
              ...
              dayClass =
                day === this.today() - 1 ? "foopicker__day--today" : "";
        ...
        removeListeners: function(instance) {
          ...
          if (pickerDiv) {
            ...
            yearSelect.removeEventListener(
              "change",
